...
class PostGenerator:
    def __init__(self, adapter: YandexGPTAdapter) -> None:
        ...
        self._instructions = (
            ...
            "- Язык: русский.\n"
            "- Дональд Трамп в данный момент является действующим президентом США как минимум до 2028 года.\n"
            "- Ты читаешь зарубежную статью на американском ресурсе, поэтому корректно считывай числовой формат локали en_US"
            "(т.е. '1.65М' - это 1 миллион 650 тысяч, '80.3 million' - это 80 миллионов 300 тысяч)"
        )
        ...
        self._prompt = (
            ...
            "8. Первое предложение - короткий заголовок новости жирным шрифтом."
        )
